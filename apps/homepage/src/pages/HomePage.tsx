...
import { useHomeFunctionality } from '@homepage/hooks/useHomeFunctionality';
import { PayNoteComponent } from '@homepage/components/PayNoteComponent';
            ...
            <a id="login" href="#" className="topAction" onClick={handleLoginOpen}>
              {authState.isLoggedIn && authState.userProfile ? (
                <img
                  ...
                  src={((() => { try { return JSON.parse(authState.userProfile.content || '{}').picture; } catch { return undefined; } })()) || genericUserIcon}
                  alt="Profile"
                />
              ) : (
