  ...
  subscribeWithSelector((set, get) => ({
    ...
    next: () =>
      set(state => {
        ...
        const newPlayedTracks = [
          ...state.playedTracks,
          state.currentTrack
        ].filter((track): track is JukeboxTrack => track !== null);
    ...
    previous: () =>
      set(state => {
        ...
        const newQueue = [state.currentTrack, ...state.queue].filter(
          (track): track is JukeboxTrack => track !== null
        );
