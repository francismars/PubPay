            ...
            return (key, nonce, data, output, counter = 0) => {
              ...
              if (extendNonceFn) {
                ...
                extendNonceFn(
                  sigma,
                  k32,
                  (0, utils_js_1.u32)(nonce.subarray(0, 16)),
                  k32
                );
        ...
        function (require, module, exports) {
          ...
          class Poly1305 {
            ...
            process(data, offset, isLast = false) {
              ...
              d2 &= 0x1fff;
              let d3 =
                c + h0 * r3 + h1 * r2 + h2 * r1 + h3 * r0 + h4 * (5 * r9);
              c = d3 >>> 13;
              d3 &= 0x1fff;
              d3 +=
                h5 * (5 * r8) +
          ...
          function wrapConstructorWithKey(hashCons) {
            const hashC = (msg, key) =>
              hashCons(key)
                .update((0, utils_js_1.toBytes)(msg))
                .digest();
          ...
          class GHASH {
            ...
            constructor(key, expectedLength) {
              ...
              if (![1, 2, 4, 8].includes(W))
                throw new Error(
                  `ghash: wrong window size=${W}, should be 2, 4 or 8`
                );
              this.W = W;
...
*/
          ...
          exports.cfb = (0, utils_js_1.wrapCipher)(
            ...
            function cfb(key, iv) {
              ...
              function processCfb(src, isEncrypt, dst) {
                ...
                // leftovers (less than block)
                const start =
                  BLOCK_SIZE * Math.floor(src32.length / BLOCK_SIZE32);
                if (start < srcLen) {
                  ({ s0, s1, s2, s3 } = encrypt(xk, s0, s1, s2, s3));
                  const buf = (0, utils_js_1.u8)(
                    new Uint32Array([s0, s1, s2, s3])
                  );
                  for (let i = start, pos = 0; i < srcLen; i++, pos++)
                    dst[i] = src[i] ^ buf[pos];
                  buf.fill(0);
          ...
          exports.siv = (0, utils_js_1.wrapCipher)(
            ...
            function siv(key, nonce, AAD) {
              ...
              function deriveKeys() {
                ...
                let counter = 0;
                for (const derivedKey of [authKey, encKey].map(
                  utils_js_1.u32
                )) {
        ...
        { './_assert.js': 2, './_polyval.js': 4, './utils.js': 7 }
      ],
      6: [
        function (require, module, exports) {
          'use strict';
            ...
            return {
              ...
              decrypt: (ciphertext, output) => {
                ...
                if (clength < tagLength)
                  throw new Error(
                    `encrypted data must be at least ${tagLength} bytes`
                  );
                if (output) {
      ...
      8: [
        function (require, module, exports) {
          ...
          function createCurve(curveDef, defHash) {
            const create = hash =>
              (0, weierstrass_js_1.weierstrass)({
                ...curveDef,
                ...getHash(hash)
              });
        ...
        {
          './abstract/weierstrass.js': 13,
          '@noble/hashes/hmac': 17,
          '@noble/hashes/utils': 19
        }
      ],
      9: [
        function (require, module, exports) {
        ...
        function (require, module, exports) {
          ...
          function i2osp(value, length) {
            if (value < 0 || value >= 1 << (8 * length)) {
              throw new Error(
                `bad I2OSP call: value=${value} length=${length}`
              );
            }
          ...
          function expand_message_xmd(msg, DST, lenInBytes, H) {
            ...
            const DST_prime = (0, utils_js_1.concatBytes)(
              DST,
              i2osp(DST.length, 1)
            );
    ...
    'addN', 'subN', 'mulN', 'sqrN'
          ...
          function validateObject(object, validators, optValidators = {}) {
            const checkField = (fieldName, type, isOptional) => {
              ...
              if (typeof checkVal !== 'function')
                throw new Error(
                  `Invalid validator "${type}", expected function`
                );
      ...
      13: [
        function (require, module, exports) {
          ...
          exports.DER = {
            ...
            toSig(hex) {
              ...
              const { d: r, l: sBytes } = exports.DER._parseInt(
                data.subarray(2)
              );
        ...
        { './curve.js': 9, './modular.js': 11, './utils.js': 12 }
      ],
      14: [
        function (require, module, exports) {
          'use strict';
      ...
      20: [
        function (require, module, exports) {
          ...
          const mapSWU = /* @__PURE__ */ (() =>
            (0, weierstrass_js_1.mapToCurveSimpleSWU)(Fp, {
              A: BigInt(
        ...
        {
          './_shortw_utils.js': 8,
          './abstract/hash-to-curve.js': 10,
          './abstract/modular.js': 11,
          './abstract/utils.js': 12,
          './abstract/weierstrass.js': 13,
          '@noble/hashes/sha256': 18,
          '@noble/hashes/utils': 19
        }
      ],
      21: [
      ...
      24: [
        function (require, module, exports) {
          ...
          function extract(hash, ikm, salt) {
            ...
            return (0, hmac_js_1.hmac)(
              hash,
              (0, utils_js_1.toBytes)(salt),
              (0, utils_js_1.toBytes)(ikm)
            );
          }
        ...
        { './_assert.js': 21, './hmac.js': 25, './utils.js': 27 }
      ],
      25: [
        function (require, module, exports) {
          'use strict';
    ...
    0x6a09e667, 0xbb67ae85, 0x3c6ef372, 0xa54ff53a, 0x510e527f, 0x9b05688c, 0x1f83d9ab, 0x5be0cd19
          ...
          function genBech32(encoding) {
            ...
            function decode(str, limit = 90) {
              ...
              if (!_words.endsWith(sum))
                throw new Error(
                  `Invalid checksum in ${str}: expected "${sum}"`
                );
              return { prefix, words };
            }
      ...
      'nostr-tools': [
        function (require, module, exports) {
          ...
          var JS = class {
            ...
            getPublicKey(secretKey) {
              return (0, import_utils.bytesToHex)(
                import_secp256k1.schnorr.getPublicKey(secretKey)
              );
            }
            finalizeEvent(t, secretKey) {
              const event = t;
              event.pubkey = (0, import_utils.bytesToHex)(
                import_secp256k1.schnorr.getPublicKey(secretKey)
              );
              event.id = getEventHash(event);
              event.sig = (0, import_utils.bytesToHex)(
                import_secp256k1.schnorr.sign(getEventHash(event), secretKey)
              );
            ...
            verifyEvent(event) {
              ...
              try {
                const valid = import_secp256k1.schnorr.verify(
                  event.sig,
                  hash,
                  event.pubkey
                );
          ...
          function mergeFilters(...filters) {
            ...
            for (let i2 = 0; i2 < filters.length; i2++) {
              ...
              if (
                filter.limit &&
                (!result.limit || filter.limit > result.limit)
              )
                result.limit = filter.limit;
              if (
                filter.until &&
                (!result.until || filter.until > result.until)
              )
                result.until = filter.until;
              if (
                filter.since &&
                (!result.since || filter.since < result.since)
              )
          ...
          var AbstractRelay = class {
            ...
            async auth(signAuthEvent) {
              if (!this.challenge)
                throw new Error(
                  "can't perform auth, no challenge was received"
                );
              const evt = await signAuthEvent(
                makeAuthEvent(this.url, this.challenge)
              );
            ...
            async count(filters, params) {
              ...
              this.send(
                '["COUNT","' + id + '",' + JSON.stringify(filters).substring(1)
              );
              return ret;
            }
          ...
          var AbstractSimplePool = class {
            ...
            subscribeMany(relays, filters, params) {
              return this.subscribeManyMap(
                Object.fromEntries(relays.map(url => [url, filters])),
                params
              );
            }
          ...
          function decode(nip19) {
            let { prefix, words } = import_base.bech32.decode(
              nip19,
              Bech32MaxSize
            );
            ...
            switch (prefix) {
              ...
              case 'nevent': {
                ...
                return {
                  ...
                  data: {
                    ...
                    relays: tlv[1]
                      ? tlv[1].map(d => utf8Decoder.decode(d))
                      : [],
                    author: tlv[2]?.[0]
                      ? (0, import_utils5.bytesToHex)(tlv[2][0])
                      : void 0,
                    kind: tlv[3]?.[0]
                      ? parseInt((0, import_utils5.bytesToHex)(tlv[3][0]), 16)
                      : void 0
                  }
                };
              }
              case 'naddr': {
                ...
                return {
                  ...
                  data: {
                    ...
                    kind: parseInt(
                      (0, import_utils5.bytesToHex)(tlv[3][0]),
                      16
                    ),
                    relays: tlv[1] ? tlv[1].map(d => utf8Decoder.decode(d)) : []
                  }
              ...
              case 'note':
                return {
                  type: prefix,
                  data: (0, import_utils5.bytesToHex)(data)
                };
              default:
          ...
          function neventEncode(event) {
            ...
            let data = encodeTLV({
              ...
              2: event.author
                ? [(0, import_utils5.hexToBytes)(event.author)]
                : [],
          ...
          async function encrypt(secretKey, pubkey, text) {
            const privkey =
              secretKey instanceof Uint8Array
                ? (0, import_utils7.bytesToHex)(secretKey)
                : secretKey;
            const key = import_secp256k12.secp256k1.getSharedSecret(
              privkey,
              '02' + pubkey
            );
            ...
            let ciphertext = (0, import_aes.cbc)(normalizedKey, iv).encrypt(
              plaintext
            );
          ...
          async function decrypt(secretKey, pubkey, data) {
            ...
            let key = import_secp256k12.secp256k1.getSharedSecret(
              privkey,
              '02' + pubkey
            );
            ...
            let plaintext = (0, import_aes.cbc)(normalizedKey, iv).decrypt(
              ciphertext
            );
          ...
          async function queryProfile(fullname) {
            ...
            try {
              ...
              const res = await (
                await _fetch(url, { redirect: 'error' })
              ).json();
          ...
          var channelMessageEvent = (t, privateKey) => {
            const tags = [
              ['e', t.channel_create_event_id, t.relay_url, 'root']
            ];
          ...
          var regex2 = () =>
            new RegExp(`\\B${EMOJI_SHORTCODE_REGEX.source}\\B`, 'g');
          ...
          async function validateGithub(pubkey, username, proof) {
            try {
              let res = await (
                await _fetch3(
                  `https://gist.github.com/${username}/${proof}/raw`
                )
              ).text();
              return (
                res ===
          ...
          function getConversationKey(privkeyA, pubkeyB) {
            const sharedX = import_secp256k13.secp256k1
              .getSharedSecret(privkeyA, '02' + pubkeyB)
              .subarray(1, 33);
            return (0, import_hkdf.extract)(
              import_sha2562.sha256,
              sharedX,
              'nip44-v2'
            );
          }
          function getMessageKeys(conversationKey, nonce) {
            const keys = (0, import_hkdf.expand)(
              import_sha2562.sha256,
              conversationKey,
              nonce,
              76
          ...
          function pad(plaintext) {
            ...
            const suffix = new Uint8Array(
              calcPaddedLen(unpaddedLen) - unpaddedLen
            );
          ...
          function encrypt2(
            plaintext,
            conversationKey,
            nonce = (0, import_utils10.randomBytes)(32)
          ) {
            ...
            const ciphertext = (0, import_chacha.chacha20)(
              chacha_key,
              chacha_nonce,
              padded
            );
            const mac = hmacAad(hmac_key, ciphertext, nonce);
            return import_base3.base64.encode(
              (0, import_utils10.concatBytes)(
                new Uint8Array([2]),
                nonce,
                ciphertext,
                mac
          ...
          function decrypt2(payload, conversationKey) {
            ...
            const padded = (0, import_chacha.chacha20)(
              chacha_key,
              chacha_nonce,
              ciphertext
            );
          ...
          async function getToken(
            ...
            return (
              authorizationScheme +
              import_base5.base64.encode(
                utf8Encoder.encode(JSON.stringify(signedEvent))
              )
            );
          }
          async function validateToken(token, url, method) {
            ...
            const valid = await validateEvent2(event, url, method).catch(
              error => {
                throw error;
              }
            );
          ...
          async function unpackEventFromToken(token) {
            ...
            const eventB64 = utf8Decoder.decode(
              import_base5.base64.decode(token)
            );
            if (
              !eventB64 ||
              eventB64.length === 0 ||
          ...
          function validateEventTimestamp(event) {
            ...
            return (
              Math.round(new Date().getTime() / 1e3) - event.created_at < 60
            );
          }
          ...
          function hashPayload(payload) {
            const hash = (0, import_sha2563.sha256)(
          ...
          async function validateEvent2(event, url, method, body) {
            ...
            if (!validateEventTimestamp(event)) {
              throw new Error(
                'Invalid nostr event, created_at timestamp invalid'
              );
            }
        ...
        {
          '@noble/ciphers/aes': 5,
          '@noble/ciphers/chacha': 6,
          '@noble/ciphers/utils': 7,
          '@noble/curves/secp256k1': 20,
          '@noble/hashes/hkdf': 24,
          '@noble/hashes/hmac': 25,
          '@noble/hashes/sha256': 26,
