...
const RoomViewerPage = lazy(() =>
  import('./pages/RoomViewerPage').then(m => ({ default: m.RoomViewerPage }))
);
const RoomAdminPage = lazy(() =>
  import('./pages/RoomAdminPage').then(m => ({ default: m.RoomAdminPage }))
);
const RoomCreatePage = lazy(() =>
  import('./pages/RoomCreatePage').then(m => ({ default: m.RoomCreatePage }))
);
const MultiLoginPage = lazy(() =>
  import('./pages/MultiLoginPage').then(m => ({ default: m.MultiLoginPage }))
);
const PretalxDiagnosePage = lazy(() =>
  import('./pages/PretalxDiagnosePage').then(m => ({
    default: m.PretalxDiagnosePage
  }))
);
const MultiStatsPage = lazy(() =>
  import('./pages/MultiStatsPage').then(m => ({ default: m.MultiStatsPage }))
);
  ...
  return (
    <Suspense fallback={<LoadingFallback />}>
      <Routes>
        ...
        <Route
          path="/live/pretalx/diagnose"
          element={<PretalxDiagnosePage />}
        />
